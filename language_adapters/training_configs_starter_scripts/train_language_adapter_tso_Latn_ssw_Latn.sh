...
TOKENIZED_DIR="${WORK_ROOT:-/path/to/work_root}/tokenized_data_subsets/gemma3-4b-pt/tso_Latn_ssw_Latn/"
TOKENIZER_PATH="google/gemma-3-4b-pt"
MODEL_NAME="google/gemma-3-4b-pt"
OUTPUT_DIR="${WORK_ROOT:-/path/to/work_root}/results_language_adapters/gemma3-4b-pt/tso_Latn_ssw_Latn"
LOGGING_DIR="${WORK_ROOT:-/path/to/work_root}/results_language_adapters/gemma3-4b-pt/tso_Latn_ssw_Latn/logs"
mkdir -p "$LOGGING_DIR"
...
RUN_NAME="gemma3-4b-pt-tso_Latn_ssw_Latn-adapter"
...
EVAL_TASKS="belebele_tso_Latn,belebele_ssw_Latn"
EVAL_METRICS_EARLYSTOPPING="belebele_tso_Latn,belebele_ssw_Latn"
...
EVAL_WANDB_PROJECT="gemma3-4b-pt-tso_Latn_ssw_Latn-adapter"
