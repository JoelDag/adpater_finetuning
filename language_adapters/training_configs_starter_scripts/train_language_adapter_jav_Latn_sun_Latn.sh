...
RUN_NAME="mistral7b-jav_Latn_sun_Latn-adapter"
...
EVAL_TASKS="belebele_sun_Latn,belebele_jav_Latn"
EVAL_METRICS_EARLYSTOPPING="belebele_sun_Latn,belebele_jav_Latn"
...
EVAL_WANDB_PROJECT="mistral7b-jav_Latn_sun_Latn-adapter"
LOG_FILE="$OUTPUT_DIR/jav_Latn_sun_Latn.log"
