...
TOKENIZED_DIR="${WORK_ROOT:-/path/to/work_root}/tokenized_data_subsets/gemma3-4b-pt/indo_aryan"
TOKENIZER_PATH="${WORK_ROOT:-/path/to/work_root}/tokenized_data_subsets/gemma_extended_tokenizers/indo_aryan/"
MODEL_NAME="google/gemma-3-4b-pt"
OUTPUT_DIR="${WORK_ROOT:-/path/to/work_root}/results_language_adapters/gemma3-4b-pt/indo_aryan"
LOGGING_DIR="${WORK_ROOT:-/path/to/work_root}/results_language_adapters/gemma3-4b-pt/indo_aryan/logs"
