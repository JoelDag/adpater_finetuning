...
BASE_DIR="${BASE_DIR:-./results/mistral7b/niger_congo}"
...
LIMIT="${LIMIT:-150}"
WANDB_PROJECT="${WANDB_PROJECT:-mistral7b_niger_congo_adapter_evaluation}"
WANDB_GROUP="${WANDB_GROUP:-mistral_eval_niger_congo_qlora}"
RUN_NAME="${RUN_NAME:-niger_congo_eval}"
mkdir -p "$BASE_DIR"
