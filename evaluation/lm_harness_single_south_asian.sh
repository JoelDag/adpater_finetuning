...
BASE_DIR="${BASE_DIR:-./results/mistral7b/south_asian}"
...
LIMIT="${LIMIT:-150}"
WANDB_PROJECT="${WANDB_PROJECT:-mistral7b_south_asian_adapter_evaluation}"
WANDB_GROUP="${WANDB_GROUP:-mistral_eval_south_asian_qlora}"
RUN_NAME="${RUN_NAME:-south_asian_eval}"
mkdir -p "$BASE_DIR"
